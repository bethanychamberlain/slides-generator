...
# Model IDs — override via env vars without rebuilding the image
MODELS = {
    "anthropic": {
        "fast": os.environ.get("ANTHROPIC_MODEL_FAST", "claude-sonnet-4-6"),
        "advanced": os.environ.get("ANTHROPIC_MODEL_ADVANCED", "claude-opus-4-6"),
    },
    "mistral": {
        "fast": os.environ.get("MISTRAL_MODEL_FAST", "mistral-medium-latest"),
        "advanced": os.environ.get("MISTRAL_MODEL_ADVANCED", "mistral-large-latest"),
    },
}
