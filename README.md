...
- **[Mistral Vibe Code](https://docs.mistral.ai/capabilities/vibe-coding/)** — Used as a second pair of "eyes" to review and sanity-check Claude's output / act as a "pair programer"to Claude Code, not as a primary development tool
